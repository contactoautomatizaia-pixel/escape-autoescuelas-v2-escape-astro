...
(function () {
  ...
  const CATEGORIES = [
    {
      key: "necessary",
      name: "Necesarias",
      desc: "Imprescindibles para el funcionamiento básico. No pueden desactivarse.",
      required: true,
    },
    {
      key: "analytics",
      name: "Analíticas",
      desc: "Nos ayudan a entender cómo usas la web (Google Analytics, etc.).",
      required: false,
    },
    {
      key: "marketing",
      name: "Marketing",
      desc: "Permiten mostrarte anuncios relevantes en otras webs.",
      required: false,
    },
  ];
  ...
  function applyConsent(prefs) {
    // Aquí activar/desactivar scripts de terceros según prefs
    if (typeof window.onEscapeCookieConsent === "function") {
      window.onEscapeCookieConsent(prefs);
    }
    // Ejemplo: activar GA si analytics=true
